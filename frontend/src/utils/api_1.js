const DJANGO_API = import.meta.env.VITE_DJANGO_API_URL || 'http://localhost:8000/api';
const FASTAPI_API = import.meta.env.VITE_FASTAPI_API_URL || 'http://localhost:8001';
